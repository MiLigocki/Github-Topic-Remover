// ==UserScript==
// @name         Github Explore Filter
// @namespace    https://github.com/MiLigocki
// @version      0.1
// @description  remove project by word filtering in github/explore
// @author       MiLigocki
...
var fun = function() {
    ...
    function hideByFilter(keywords){
        var repoList = window.document.querySelector('.col-md-8.col-lg-6.py-4');
